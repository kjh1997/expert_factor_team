...
# -----------------------------------------------------------ntis 코드 ---------------------------------------------------------------
for ntis_author_paper_id in AuthorPapers_A_ID_AND_Papers[0:20]:
    for id in ntis_author_paper_id['papers']:
        ...
        ntis_data.append(list(ntis_rawdata.find({"_id":id},{"mngId":1,"koTitle":1,"enTitle":1,"absAbs":1,"effAbs":1,"koKeyword":1,"enKeyword":1,"goalAbs":1})))
