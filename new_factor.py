...
# 94:95
        ...
        'totalFund':1,"mngId":1,"prdEnd":1,"prdStart":1,"qryKeyword":1}))
            ...
            self.author_paper_data_dict[A_ID_Data['A_ID']] = papers_data
    ...
    def printa(self):
        for i in self.author_paper_data_dict:
            ...
            #print("id", )
            sc_result = self.scienceon_run(self.author_paper_data_dict[i][1]['scienceon_data'],self.author_paper_data_dict[i][0]['Scienceon_id'])
...
pYears, keywords, {'issueInsts' : issueInsts, 'issueLangs' : issueLangs, 'citation' : citation}, {'authors' : authors, 'A_ID' : A_ID  }, authorInsts , qryKeyword
